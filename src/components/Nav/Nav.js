...
const Nav = props => {
    return (
        <nav className="h-20 w-100 bg-white text-black-50">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="md:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="#" className="bg-white-300 text-black font-bold px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                            <label htmlFor="search" className="sr-only block text-sm font-medium text-gray-700">
                                Search
                            </label>
                            <div className="mt-1 flex shadow-sm">
                                <input type="text" name="search" id="search" className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full sm:text-sm border-2 border-indigo-600 pl-2" placeholder="Search" />
                    ...
                    <div className="md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            <div className="ml-3 relative">
                                <div>
                                    <button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-black" id="user-menu" aria-haspopup="true">
